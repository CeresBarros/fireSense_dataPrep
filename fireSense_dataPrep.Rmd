...
```{r moduleParams}
df_params <- moduleParams("fireSense_DataPrep", "..")
...
If `sourceURL` is specified, `downloadData("fireSense_DataPrep", "path/to/modules/dir")` may be sufficient.

```{r moduleInputs}
df_inputs <- moduleInputs("fireSense_DataPrep", "..")
...
```{r moduleOutputs}
df_outputs <- moduleOutputs("fireSense_DataPrep", "..")
